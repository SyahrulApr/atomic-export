# Skrip Demo Atomic Export
### BI-OJK PIDI DIGDAYA Hackathon 2026 — Fase 2

> **Petunjuk:** Bacakan teks di bawah ini secara verbatim. Teks dalam `[kurung kotak]` adalah instruksi aksi di layar — **jangan dibacakan**, lakukan saja.

---

## ADEGAN 1 — Landing Page

`[Buka browser, tampilkan halaman utama Atomic Export di localhost:3000]`

---

Selamat datang.

Hari ini kami akan memperkenalkan **Atomic Export** — sebuah *operating system* ekspor yang dirancang khusus untuk UMKM Indonesia.

Masalah yang kami selesaikan sederhana tapi krusial: mengapa UMKM yang memiliki produk berkualitas ekspor tetap tidak bisa menembus pasar global secara mandiri? Jawabannya ada tiga: birokrasi yang kompleks, akses pasar yang tersentralisasi di tangan agregator, dan tidak adanya rekam jejak yang bisa digunakan untuk mengakses pembiayaan.

Atomic Export memecah ketiga hambatan itu dalam satu platform terintegrasi — dari kesiapan ekspor, kepatuhan dokumen otomatis, matchmaking buyer, jaminan mutu, konsolidasi logistik, hingga pembentukan rekam jejak kredit.

Sekarang kami akan menunjukkan bagaimana cara kerjanya, dari awal sampai akhir.

`[Scroll perlahan ke bawah untuk memperlihatkan seksi-seksi landing page]`

Platform ini dibangun di atas empat fase: *Frictionless Execution*, *Intelligent Automation*, *Network Aggregation*, dan *Financial Inclusion*. Setiap fase saling menguatkan dalam satu *flywheel* kepercayaan dan skala.

Mari kita masuk ke dalam sistemnya.

`[Klik tombol "Masuk ke Dashboard" atau navigasi ke /login]`

---

## ADEGAN 2 — Login

`[Halaman login terbuka. Tampilkan form username dan password]`
...
`[Ketik password: atomicexport2026]`

`[Klik tombol "Masuk"]`

Sistem memverifikasi identitas, lalu mengarahkan kita langsung ke dashboard.

---

## ADEGAN 3 — Dashboard: Tur Pemandu (18 Langkah)

`[Dashboard terbuka. Klik tombol "Mulai Demo Pemandu" di pojok kanan bawah]`

`[Tooltip muncul: Langkah 1 dari 18]`
...
### Langkah 2 — Metrik Kunci dalam Satu Layar
...
### Langkah 3 — Flywheel of Trust & Scale

Inilah arsitektur besar Atomic Export: enam tahap yang membentuk *flywheel*.

Mulai dari **Frictionless Execution** di Tahap 1, naik ke **Autonomous Compliance** di Tahap 2, kemudian **Integrated Education** dan **Community Building** di Tahap 3 dan 4, diikuti **Algorithmic Gatekeeper** untuk kontrol mutu di Tahap 5, dan puncaknya di Tahap 6: **Network Aggregation** — di mana UMKM kecil bisa tampil sekelas eksportir besar.

`[Klik Lanjut]`

---

### Langkah 4 — Atomic Steps: Gamifikasi Birokrasi

`[Panel berpindah ke Atomic Steps]`

Inilah inovasi utama Tahap 1.
...
### Langkah 5 — Tugas Harian Terpandu
...
### Langkah 6 — AI Copilot Menjawab Regulasi

`[Panel berpindah ke AI Copilot. Animasi mengetik dimulai secara otomatis]`
...
### Langkah 7 — Export Readiness Score
...
### Langkah 9 — Single-Entry, Multi-Output

`[Panel berpindah ke Dokumen]`

Salah satu titik paling menyakitkan bagi eksportir UMKM adalah mengisi formulir berulang kali untuk dokumen yang berbeda — padahal datanya sama.

Atomic Export menerapkan prinsip **single-entry, multi-output**: satu kali input data produk dan transaksi, sistem menghasilkan **enam dokumen perdagangan secara otomatis**, lengkap dan tanpa error manual.

`[Klik Lanjut]`

---

### Langkah 10 — Dokumen Siap Unduh
...
### Langkah 11 — P2P2B Matchmaking

`[Panel berpindah ke Market & P2P2B]`
...
### Langkah 12 — Konsorsium Groupage
...
### Langkah 13 — QC Hybrid: Computer Vision
...
### Langkah 15 — Konsolidasi LCL ke FCL

`[Panel berpindah ke Logistik]`
...
### Langkah 16 — Penerbitan PKBE

Legalitasnya bagaimana? Terjamin.

**PKBE — Pemberitahuan Konsolidasi Barang Ekspor** — diterbitkan oleh konsolidator yang sudah disetujui Direktorat Jenderal Bea dan Cukai. Meski berbagi kontainer, **setiap UMKM tetap memegang satu PEB sendiri** atas namanya. Ini yang membangun rekam jejak ekspor yang sah dan individual.

`[Klik Lanjut]`

---

### Langkah 17 — Alternative Credit Score

`[Panel berpindah ke Track Record]`
...
### Langkah 18 — Rekam Jejak Permanen
...
Itulah alur penuh Atomic Export.
...
`[Tur selesai. Dashboard kembali ke tampilan normal. Layar menampilkan Track Record]`

---

Dari landing page hingga rekam jejak kredit — itulah yang bisa dilakukan Atomic Export dalam satu siklus ekspor.

Kami tidak hanya membantu UMKM **bisa ekspor**. Kami membantu UMKM **ekspor atas nama sendiri**, membangun identitas keuangan yang sebelumnya tidak pernah mereka punya, dan menciptakan jalur yang berulang — bukan satu kali coba.

Visi kami sederhana: **setiap UMKM Indonesia yang punya produk layak ekspor, layak juga mendapat akses modal**.

Atomic Export adalah jembatan antara keduanya.

Terima kasih.

---

*Atomic Export © 2026 — Tetra Core Team · BI-OJK PIDI DIGDAYA Hackathon*
